...
class LoginViewTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user = CustomUserModel.objects.create_user(
            ...
            is_email_verified=True,  # Assuming email verification is required for login
        )
    ...
    def test_login_inactive_user(self):
        inactive_user = CustomUserModel.objects.create_user(
        ...
        # The exact message might depend on your MyTokenObtainPairSerializer or DRF defaults
        # For SimpleJWT, it often is: "No active account found with the given credentials"
    ...
    def test_login_missing_password(self):
        ...
        # Check the error detail directly in response.data
